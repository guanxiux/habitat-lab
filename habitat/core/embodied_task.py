...
from typing import Any, Dict, Iterable, List, Optional, Union, MutableMapping
...
class EmbodiedTask:
    ...
    def step(self, action: Dict[str, Any], episode: Episode):
        ...
        elif isinstance(action_name, MutableMapping):
            self._step_multi_agent_action(observations,
                 action)
        else:
            self._step_single_action(
